...
export default async function JaLifestyleBlogList({
  searchParams,
}: {
    ...
    <div>
      ...
      {posts.length === 0 ? (
        <div className="text-center py-20">
          <p className="text-gray-400 mb-3">&#39;{tag}&#39; タグの記事はありません。</p>
          <a href="/ja/blog" style={{ color: "var(--color-primary)" }} className="text-sm">
            全記事を見る →
          </a>
        </div>
      ) : (
