...
export default async function EnLifestyleBlogList({
  searchParams,
}: {
    ...
    <div>
      ...
      {posts.length === 0 ? (
        <div className="text-center py-20">
          <p className="text-gray-400 mb-3">No posts found for tag &#39;{tag}&#39;.</p>
          <a href="/en/blog" style={{ color: "var(--color-primary)" }} className="text-sm">
            View all posts →
          </a>
        </div>
      ) : (
